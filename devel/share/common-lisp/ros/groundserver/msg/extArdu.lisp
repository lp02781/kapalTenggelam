...
;//! \htmlinclude extArdu.msg.html

(cl:defclass <extArdu> (roslisp-msg-protocol:ros-message)
  ((arduYaw
    :reader arduYaw
    :initarg :arduYaw
    :type cl:float
...
(cl:defclass extArdu (<extArdu>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <extArdu>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'extArdu)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name groundserver-msg:<extArdu> is deprecated: use groundserver-msg:extArdu instead.")))

(cl:ensure-generic-function 'arduYaw-val :lambda-list '(m))
(cl:defmethod arduYaw-val ((m <extArdu>))
...
(cl:defmethod arduThrottle-val ((m <extArdu>))
...
(cl:defmethod arduPitch-val ((m <extArdu>))
...
(cl:defmethod arduRoll-val ((m <extArdu>))
...
(cl:defmethod arduArmGripOn-val ((m <extArdu>))
...
(cl:defmethod arduArmGripOff-val ((m <extArdu>))
...
(cl:defmethod arduStabilizeMode-val ((m <extArdu>))
...
(cl:defmethod arduRemoteArmed-val ((m <extArdu>))
  ...
  (arduRemoteArmed m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <extArdu>) ostream)
  "Serializes a message object of type '<extArdu>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <extArdu>) istream)
  "Deserializes a message object of type '<extArdu>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<extArdu>)))
  "Returns string type for a message object of type '<extArdu>"
  "groundserver/extArdu")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'extArdu)))
  "Returns string type for a message object of type 'extArdu"
  "groundserver/extArdu")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<extArdu>)))
  "Returns md5sum for a message object of type '<extArdu>"
  "444e27210a1cc7337dd2f2ca6321c819")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'extArdu)))
  "Returns md5sum for a message object of type 'extArdu"
  "444e27210a1cc7337dd2f2ca6321c819")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<extArdu>)))
  "Returns full string definition for message of type '<extArdu>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'extArdu)))
  "Returns full string definition for message of type 'extArdu"
  (cl:format cl:nil "float32 arduYaw ~%float32 arduThrottle~%float32 arduPitch~%float32 arduRoll~%int32 arduArmGripOn~%int32 arduArmGripOff~%int32 arduStabilizeMode~%int32 arduRemoteArmed~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <extArdu>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <extArdu>))
