...
;//! \htmlinclude arduControl.msg.html

(cl:defclass <arduControl> (roslisp-msg-protocol:ros-message)
  ((arduYaw
    :reader arduYaw
    :initarg :arduYaw
    :type cl:float
...
(cl:defclass arduControl (<arduControl>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <arduControl>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'arduControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name groundserver-msg:<arduControl> is deprecated: use groundserver-msg:arduControl instead.")))

(cl:ensure-generic-function 'arduYaw-val :lambda-list '(m))
(cl:defmethod arduYaw-val ((m <arduControl>))
...
(cl:defmethod arduThrottle-val ((m <arduControl>))
...
(cl:defmethod arduPitch-val ((m <arduControl>))
...
(cl:defmethod arduRoll-val ((m <arduControl>))
...
(cl:defmethod arduArmGripOn-val ((m <arduControl>))
...
(cl:defmethod arduArmGripOff-val ((m <arduControl>))
...
(cl:defmethod arduArmRoll-val ((m <arduControl>))
...
(cl:defmethod arduLedOnOff-val ((m <arduControl>))
  ...
  (arduLedOnOff m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <arduControl>) ostream)
  "Serializes a message object of type '<arduControl>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <arduControl>) istream)
  "Deserializes a message object of type '<arduControl>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<arduControl>)))
  "Returns string type for a message object of type '<arduControl>"
  "groundserver/arduControl")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'arduControl)))
  "Returns string type for a message object of type 'arduControl"
  "groundserver/arduControl")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<arduControl>)))
  "Returns md5sum for a message object of type '<arduControl>"
  "8be09c0c14bfbf4e4fcbd8778a348742")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'arduControl)))
  "Returns md5sum for a message object of type 'arduControl"
  "8be09c0c14bfbf4e4fcbd8778a348742")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<arduControl>)))
  "Returns full string definition for message of type '<arduControl>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'arduControl)))
  "Returns full string definition for message of type 'arduControl"
  (cl:format cl:nil "float32 arduYaw ~%float32 arduThrottle~%float32 arduPitch~%float32 arduRoll~%int32 arduArmGripOn~%int32 arduArmGripOff~%int32 arduArmRoll~%int32 arduLedOnOff~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <arduControl>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <arduControl>))
