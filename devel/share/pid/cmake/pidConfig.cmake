...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/mfikih15/Documents/kapalTenggelam/serverGabut/src/pid)
  set(pid_DEVEL_PREFIX /home/mfikih15/Documents/kapalTenggelam/serverGabut/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/mfikih15/Documents/kapalTenggelam/serverGabut/install)
...
if(NOT "/home/mfikih15/Documents/kapalTenggelam/serverGabut/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mfikih15/Documents/kapalTenggelam/serverGabut/src/pid/${idir}'.  ${_report}")
    endif()
