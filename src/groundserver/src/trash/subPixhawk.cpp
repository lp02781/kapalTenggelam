...
#define minPitch 	1200
#define minRoll 	1200
#define minThrottle 1200
#define minYaw 		1200

#define middlePitch  	1500
#define middleRoll  	1500
#define middleThrottle  1500
#define middleYaw  		1500
...
int main(int argc, char** argv){
	...
	ros::Subscriber sub_rov_throttle 	= n.subscribe<std_msgs::Float32>("/rov/input/throttle", 1, throttleCallback);
	ros::Subscriber sub_rov_steering 	= n.subscribe<std_msgs::Float32>("/rov/input/steering", 1, steeringCallback);
	ros::Subscriber sub_rov_altitude	= n.subscribe<std_msgs::Float32>("/rov/input/altitude", 1, altitudeCallback);
	ros::Subscriber sub_rov_gripOn 		= n.subscribe<std_msgs::Int16>("/rov/input/gripOn", 1, gripOnCallback);
	ros::Subscriber sub_rov_gripOff 	= n.subscribe<std_msgs::Int16>("/rov/input/gripOff", 1, gripOffCallback);
	ros::Subscriber sub_rov_armed 		= n.subscribe<std_msgs::Int16>("/rov/input/armed", 1, armedCallback);
	ros::Subscriber sub_rov_stabilize 	= n.subscribe<std_msgs::Int16>("/rov/input/stabilize", 1, stabilizeCallback);
